...
time rsync -av /afs/cern.ch/project/cvs/reps/CMSSW/COMP/SITECOMM/ tmp/cvs/CMSSW/COMP/COMPPROJECT/
...
git push https://:@git.cern.ch/kerberos/sitecomm --mirror
